...
export class CreateCatalogoDto {
  ...
  @IsString({ message: 'El campo nombre de catalogo debe ser una cadena de texto' })
  nombreCatalogo: string;

  @IsNotEmpty({ message: 'El campo valor de catalogo no puede estar vacío' })
  @MaxLength(13, { message: 'El campo valor de catalogo tiene un máximo de 70 caracteres'})
  @IsString({ message: 'El campo valor de catalogo debe ser una cadena de texto' })
