...
export class UpdateCatalogoDto {
  ...
  @MaxLength(70, { message: 'El campo nombre de catalogo debe tiene un máximo de 70 caracteres' })
  @IsString({
  ...
  @MaxLength(70, { message: 'El campo valor de catalogo debe tiene un máximo de 70 caracteres' })
  @IsString({
