...
export class CreateLocalDto {
  ...
  @MaxLength(50, {
    message: 'El campo dirección no puede tener más de 50 caracteres',
  })
  direccion: string;
  ...
  @MaxLength(20, {
    message: 'El campo sector no puede tener más de 20 caracteres',
  })
  sector: string;

  @IsNotEmpty({ message: 'El campo nombre del local no puede estar vacío' })
  @IsString({
    message: 'El campo nombre del local debe ser una cadena de texto',
  })
  @MaxLength(20, {
    message: 'El campo nombre del local no puede tener más de 20 caracteres',
  })
  nombreLocal: string;
  ...
  @MaxLength(10, {
    message: 'El campo dimensiones no puede tener más de 10 caracteres',
  })
  dimensiones: string;

  @IsBoolean({
    message: 'El campo estado solo puede ser un valor de verdadero o falso',
  })
  estado: boolean;
  ...
  @IsPositive({
    message: 'El campo tarifa por hora debe ser un valor positivo',
  })
  tarifaXHora: number;
  ...
  @IsNotEmpty({
    message: 'El local necesita un estado de disponibilidad registrado',
  })
